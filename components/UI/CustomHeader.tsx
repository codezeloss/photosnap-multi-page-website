  ...
  return (
    <section className="max-h-[490px] mx-auto flex flex-row 6bp:flex-col-reverse 6bp:max-h-[100%]">
      <div className="bg-pure-black flex items-center">
        <div className="w-[610px] flex gap-[106px] py-[173px] pr-[111px] 1bp:w-[100%] 4bp:w-[495px] 4bp:gap-[48px] 4bp:pr-[54px] 6bp:flex-col 6bp:py-0 6bp:px-[28px]">
      ...
      <div>
        <Image
          className="object-cover w-[830px] h-[490px] 1bp:w-[100%] 1bp:min-w-[830px] 6bp:w-[100%] 6bp:h-[100%]"
          src={src}
          alt="Hero"
          priority
        />
